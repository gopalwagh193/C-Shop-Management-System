...
namespace shopmanagement
{
    public partial class model : Form
    {
        ...
        {
            count = ds.Tables["model"].Rows.Count;
            if (count == 0)
            {
                keyy = 1;
            }
            ...
            {
                dr = ds.Tables["model"].Rows[count - 1];
        ...
        private void bsave_Click(object sender, EventArgs e)
        {
            ...
            {
                dr = ds.Tables["model"].NewRow();


                //dr["keyy"] = keyy;
                dr["name"] = tname.Text;

                ds.Tables["model"].Rows.Add(dr);
        ...
        {
            dr = ds.Tables["model"].Rows[listBox.SelectedIndex];
        ...
        private void model_Load(object sender, EventArgs e)
        {
            ...
            da.Fill(ds, "model"); //dataadapter is filling the data using dataset of student
            cb.DataAdapter = da;

            listBox.DataSource = ds.Tables["model"];
