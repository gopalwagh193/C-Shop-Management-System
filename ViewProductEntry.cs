...
{
    public partial class ViewProductEntry : Form
    {
        ...
        {
            griddata.DataSource = ds.Tables["pentry"];

        }

        private void ViewProductEntry_Load(object sender, EventArgs e)
        {
